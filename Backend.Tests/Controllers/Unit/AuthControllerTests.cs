...
public class AuthControllerTests
{
    ...
    public void SignUp_WithValidRequest_ReturnsCreatedResponse()
    {
        ...
        var createdUser = new AuthResponse
        {
            Token = "token",
            User = new UserDto { Id = 1, FirstName = "Mia", LastName = "Cole", PhoneNumber = "5551234", Email = "mia@example.com" }
        };
        ...
        Assert.IsType<AuthResponse>(createdResult.Value);
    }
